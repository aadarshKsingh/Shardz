...
export const Box = (props) => {
  return (
<Card className="lg:rounded-3xl rounded-2xl shadow-xl px-5 lg:my-0 my-1 lg:mx-2 mx-5 bg-gradient-to-r from-[#0058c1] via-[#0061D5] to-[#006ae9] opacity-70">
  <div className="flex lg:flex-col flex-row justify-center">
    <IoIosCloud className=" lg:h-36 lg:w-36 w-16 h-12 lg:ml-0 -ml-6 invert" />
    <div className="flex lg:flex-col flex-row">
      <p className="lg:text-2xl text-md lg:py-2 pr-2  lg:pr-0 py-3 lg:whitespace-nowrap invert">BOX</p>
