    ...
    <div className="flex flex-col w-screen h-screen justify-center text-center items-center">
      <form className="flex w-96 flex-col gap-4" onSubmit={handleRegister}>
        <div>
          ...
          <TextInput value={userEmail} onChange={(e) => { setEmail(e.target.value)}} color="blue" id="email1" type="email" placeholder="Email" required />
        </div>
        <div className='py-2'>
        ...
        <Button color='blue' className='bg-[#5793FB]' type="submit">Sign up</Button>
